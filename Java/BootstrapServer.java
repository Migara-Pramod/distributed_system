                    ...
                    if (nodes.size() == 0) {
                        ...
                        if (isOkay) {
                            if (nodes.size() == 1) {
                                ...
                                reply += "2 " + nodes.get(random_1).getIp() + " " + nodes.get(random_1).getPort() + " " + nodes.get(random_1).getUsername()
                                        + " " + nodes.get(random_2).getIp() + " " + nodes.get(random_2).getPort() + " " + nodes.get(random_2).getUsername() ;
                            }
                            nodes.add(new Neighbour(ip, port, username));
                        }
                    }
